...
{
    [Route("api/clinica/{clinicaId}/consultas/basicas")]
    [Authorize]
    [ApiController]
    public class GetConsultasBasicasByClinicaController : ControllerBase
    {
        private readonly ApplicationDbContext _context;
        private IUserInfoService _userInfo;

        public GetConsultasBasicasByClinicaController(
