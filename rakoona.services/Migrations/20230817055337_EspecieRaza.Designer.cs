...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("rakoona.services.Entities.Models.Cartilla", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("rakoona.services.Entities.Models.Consultas.Cita", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("rakoona.services.Entities.Models.Pacientes.Color", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("rakoona.services.Entities.Models.Pacientes.Especie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("rakoona.services.Entities.Models.Pacientes.Familia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("rakoona.services.Entities.Models.Pacientes.GeneroAnimal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("rakoona.services.Entities.Models.Pacientes.RazaAnimal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("rakoona.services.Entities.Models.PlanDeVacunacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("rakoona.core.Entities.Models.Pacientes.DescripcionFisicaDeMascota", b =>
                {
                    ...
                    b.HasOne("rakoona.services.Entities.Models.Pacientes.RazaAnimal", "Raza")
            ...
            modelBuilder.Entity("rakoona.services.Entities.Models.Cartilla", b =>
                {
                    b.HasOne("rakoona.services.Entities.Models.Pacientes.Mascota", "Mascota")
                        .WithOne("Cartilla")
                        .HasForeignKey("rakoona.services.Entities.Models.Cartilla", "MascotaRef")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("rakoona.services.Entities.Models.Consultas.Consulta", b =>
                {
                    b.HasOne("rakoona.services.Entities.Models.Cartilla", "Cartilla")
                        .WithMany("Consultas")
            ...
            modelBuilder.Entity("rakoona.services.Entities.Models.Pacientes.Especie", b =>
                {
                    ...
                    b.HasOne("rakoona.services.Entities.Models.Pacientes.GeneroAnimal", "Genero")
                        .WithMany("Especies")
            ...
            modelBuilder.Entity("rakoona.services.Entities.Models.Pacientes.GeneroAnimal", b =>
                {
                    b.HasOne("rakoona.services.Entities.Models.Pacientes.Familia", "Familia")
                        .WithMany("Generos")
            ...
            modelBuilder.Entity("rakoona.services.Entities.Models.Pacientes.RazaAnimal", b =>
                {
                    b.HasOne("rakoona.services.Entities.Models.Pacientes.Especie", "Especie")
                        .WithMany("Razas")
