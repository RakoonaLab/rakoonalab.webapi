...
{
    public class MedicionDePulsoMap : IEntityTypeConfiguration<MedicionDePulso>
    {
        public void Configure(EntityTypeBuilder<MedicionDePulso> builder)
        {
            builder.ToTable(name: "MedicionesDePulso");
            ...
            builder.HasOne(a => a.Mascota)
                    .WithMany(b => b.MedicionesDePulso)
